...
auto Device::availableSpace() const noexcept -> uintmax_t { return 1000000; }
auto Device::availableStack() const noexcept -> uintmax_t { return 2000; }
auto Device::availableHeap() const noexcept -> uintmax_t { return 20000; }
auto Device::biggestHeapBlock() const noexcept -> uintmax_t { return 2000; }
